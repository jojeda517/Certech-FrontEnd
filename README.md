...
1. **Instalar Node.js y npm:**
   ...
   1. Verifica la instalación ejecutando **node -v** y **npm -v**.
1. **Instalar Angular CLI:**
   1. Ejecuta **npm install -g @angular/cli** para instalar Angular CLI globalmente.
1. **Instalar Visual Studio Code:**
   1. Descarga e instala Visual Studio Code desde https://code.visualstudio.com/.
   2. **Configuración del Backend con Django y MySQL:**
1. **Instalar Python y pip:**
   1. Descarga e instala Python desde <https://www.python.org/>.
   1. Verifica la instalación ejecutando **python --version** y **pip --version**.
...
1. **Instalar Django y bibliotecas requeridas:**
   1. Ejecuta **pip install django mysqlclient**.
1. **Configurar la base de datos MySQL:**
   1. Crea una base de datos en MySQL llamada certech y actualiza la configuración en el archivo **settings.py** de Django.
   2. Configuración de Bibliotecas de Python:
1. **Instalar bibliotecas de Python:**
   1. Ejecuta **pip install openpyxl pandas reportlab PyPDF2**.
   2. Configuración del Frontend con Angular:
1. **Instalar las dependencias de Angular:**
   1. En el directorio del proyecto Angular, ejecuta **npm install**.
   2. Iniciar el Entorno de Desarrollo:
1. **Iniciar el Backend de Django:**
   1. Ejecuta **python manage.py runserver** desde el directorio del proyecto Django.
1. **Iniciar el Frontend de Angular:**
   1. En el directorio del proyecto Angular, ejecuta **ng serve**.
1. **Acceder a la Aplicación:**
   1. Abre tu navegador y ve a **http://localhost:4200/** para acceder al frontend de Angular.
...
[Arquitectura del sistema ](https://viewer.diagrams.net/?tags=%7B%7D&highlight=0000ff&edit=_blank&layers=1&nav=1#G10AajVMzn1NRNjU-OtxDlLGf7yIs1wqpH)[–](https://viewer.diagrams.net/?tags=%7B%7D&highlight=0000ff&edit=_blank&layers=1&nav=1#G10AajVMzn1NRNjU-OtxDlLGf7yIs1wqpH)[ ](https://viewer.diagrams.net/?tags=%7B%7D&highlight=0000ff&edit=_blank&layers=1&nav=1#G10AajVMzn1NRNjU-OtxDlLGf7yIs1wqpH)[Draw.io](https://viewer.diagrams.net/?tags=%7B%7D&highlight=0000ff&edit=_blank&layers=1&nav=1#G10AajVMzn1NRNjU-OtxDlLGf7yIs1wqpH)[ ](https://viewer.diagrams.net/?tags=%7B%7D&highlight=0000ff&edit=_blank&layers=1&nav=1#G10AajVMzn1NRNjU-OtxDlLGf7yIs1wqpH)


[Diagrama BD](https://dbdiagram.io/d/654815217d8bbd64658804d9)[ ](https://dbdiagram.io/d/654815217d8bbd64658804d9)
...
1. **Formato de Respuestas de Error:**
   1. Todas las respuestas de error deben seguir un formato consistente que incluya un mensaje descriptivo y, si es posible, información adicional sobre el error.
1. **Logging de Errores:**
   1. Los errores deben registrarse adecuadamente en los registros del servidor para que los desarrolladores puedan rastrear y solucionar problemas.
1. **Notificaciones a Desarrolladores:**
   1. Considera implementar notificaciones automáticas a los desarrolladores cuando ocurra un error crítico para que puedan abordar rápidamente el problema.
1. **Documentación Clara:**
   1. La documentación de la API debe incluir detalles sobre los posibles errores que pueden ocurrir, cómo manejarlos y posibles soluciones.

8\.2 Códigos de Estado HTTP y su Significado:
...
1. **Django (Backend):**
   1. [Documentación Oficial de Django](mailto:https://docs.djangoproject.com/es/5.0/)
   1. [Django Rest Framework](https://www.django-rest-framework.org/)
1. **Angular (Frontend):**
   1. Documentación Oficial de Angular
   1. [Angular](https://angular.io/)
1. **Base de Datos:**
   1. Documentación de MySQL
   1. Documentación de PostgreSQL
1. **Herramientas y Servicios:**
   1. [Gunicorn - Servidor de Aplicaciones para Django](https://gunicorn.org/)
   1. Nginx - Servidor Web

12\.2 Bibliotecas y Frameworks Utilizados:

1. **Backend (Django):**
   1. [Django](https://www.djangoproject.com/)
   1. [Django Rest Framework](https://www.django-rest-framework.org/)
   1. mysqlclient (Conector MySQL para Django)
1. **Frontend (Angular):**
   1. [Angular](https://angular.io/)
   1. [Node.js](https://nodejs.org/)
   1. [npm (Gestor de Paquetes para Node.js)](https://www.npmjs.com/)
1. **Otras Bibliotecas Python Utilizadas:**
   1. openpyxl
   1. pandas
   1. reportlab
